...
void DataStore::loadPrefsInt(const char *filename, NodePrefs& _prefs, double& node_lat, double& node_lon) {
  ...
  if (file) {
    ...
    file.read((uint8_t *)&_prefs.bot_enabled, sizeof(_prefs.bot_enabled));                 // 137 (observer_node; absent in old files -> default kept)
    file.read((uint8_t *)&_prefs.bot_channel, sizeof(_prefs.bot_channel));                 // 138
    file.read((uint8_t *)&_prefs.ble_enabled, sizeof(_prefs.ble_enabled));                 // 139 (observer_node; absent in old files -> default kept)
    file.read((uint8_t *)&_prefs.bot_control_channel, sizeof(_prefs.bot_control_channel)); // 140 (observer_node; absent in old files -> default kept)
    file.read((uint8_t *)_prefs.wifi_ssid, sizeof(_prefs.wifi_ssid));                      // 141 (observer_node; absent in old files -> default kept)
    file.read((uint8_t *)_prefs.wifi_pwd, sizeof(_prefs.wifi_pwd));                        // 174
    file.read((uint8_t *)&_prefs.boot_count, sizeof(_prefs.boot_count));                   // 239 (observer_node; absent in old files -> default kept)
    file.read((uint8_t *)_prefs.obs_url, sizeof(_prefs.obs_url));                          // 243 (observer_node; absent in old files -> default kept)
    file.read((uint8_t *)_prefs.obs_token, sizeof(_prefs.obs_token));                      // 308
    file.read((uint8_t *)&_prefs.bot_channel_mask, sizeof(_prefs.bot_channel_mask));       // 373 (observer_node; absent in old files -> default kept)
    file.read((uint8_t *)&_prefs.bot_path_mask, sizeof(_prefs.bot_path_mask));             // 381
    file.read((uint8_t *)_prefs.mqtt_host, sizeof(_prefs.mqtt_host));                      // 389 (observer_node; absent in old files -> default kept)
    file.read((uint8_t *)_prefs.mqtt_user, sizeof(_prefs.mqtt_user));                      // 454
    file.read((uint8_t *)_prefs.mqtt_pwd, sizeof(_prefs.mqtt_pwd));                        // 487
    file.read((uint8_t *)_prefs.mqtt_topic, sizeof(_prefs.mqtt_topic));                    // 552
    file.read((uint8_t *)&_prefs.mqtt_tls_insecure, sizeof(_prefs.mqtt_tls_insecure));     // 585 (absent in old files -> default kept)
    file.read((uint8_t *)&_prefs.advert_dump, sizeof(_prefs.advert_dump));                 // 586 (absent in old files -> default kept)
...
void DataStore::savePrefs(const NodePrefs& _prefs, double node_lat, double node_lon) {
  ...
  if (file) {
    ...
    file.write((uint8_t *)&_prefs.bot_enabled, sizeof(_prefs.bot_enabled));                 // 137 (observer_node)
    file.write((uint8_t *)&_prefs.bot_channel, sizeof(_prefs.bot_channel));                 // 138
    file.write((uint8_t *)&_prefs.ble_enabled, sizeof(_prefs.ble_enabled));                 // 139 (observer_node)
    file.write((uint8_t *)&_prefs.bot_control_channel, sizeof(_prefs.bot_control_channel)); // 140 (observer_node)
    file.write((uint8_t *)_prefs.wifi_ssid, sizeof(_prefs.wifi_ssid));                      // 141 (observer_node)
    file.write((uint8_t *)_prefs.wifi_pwd, sizeof(_prefs.wifi_pwd));                        // 174
    file.write((uint8_t *)&_prefs.boot_count, sizeof(_prefs.boot_count));                   // 239 (observer_node)
    file.write((uint8_t *)_prefs.obs_url, sizeof(_prefs.obs_url));                          // 243 (observer_node)
    file.write((uint8_t *)_prefs.obs_token, sizeof(_prefs.obs_token));                      // 308
    file.write((uint8_t *)&_prefs.bot_channel_mask, sizeof(_prefs.bot_channel_mask));       // 373 (observer_node)
    file.write((uint8_t *)&_prefs.bot_path_mask, sizeof(_prefs.bot_path_mask));             // 381
    file.write((uint8_t *)_prefs.mqtt_host, sizeof(_prefs.mqtt_host));                      // 389 (observer_node)
    file.write((uint8_t *)_prefs.mqtt_user, sizeof(_prefs.mqtt_user));                      // 454
    file.write((uint8_t *)_prefs.mqtt_pwd, sizeof(_prefs.mqtt_pwd));                        // 487
    file.write((uint8_t *)_prefs.mqtt_topic, sizeof(_prefs.mqtt_topic));                    // 552
    file.write((uint8_t *)&_prefs.mqtt_tls_insecure, sizeof(_prefs.mqtt_tls_insecure));     // 585
    file.write((uint8_t *)&_prefs.advert_dump, sizeof(_prefs.advert_dump));                 // 586
